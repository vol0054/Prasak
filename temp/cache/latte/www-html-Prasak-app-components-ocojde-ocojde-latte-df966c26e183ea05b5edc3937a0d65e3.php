...
list($_b, $_g, $_l) = $template->initialize('3545478380', 'html')
;
...
<section id="ocojde">
    <div class="container">
    <h2 class="text-center">Da fuq ? </h2>
    
    <p>Bánsky prasak je tu pre všetkých milovníkov a pobíjačov piva, ktorý pri chlastaní nezostanú len v jednej hospode.
	Bánsky prasák, ako to už z jeho mena vyplýva, je ťažký a náročny závod, a to nie len fyzický ale aj mentálne. Nejde tu samozrejme len pivo, ale predovšetkým o výdrž ! Ako team budete podliehať rôznym nástrahám a fyzikálnym zákonom, ktoré na vás zákerná príroda nachystala. Či už o pôjde o zhoršenie notorických schopností, zvýšené opakujúce sa pôsobenie gravitácie alebo používanie mapy pri zhoršených viditelnostnych podmienkach. Treba mať tímového ducha a sebazaprenie ktoré vás bezpečne dostane do cieľa. Pre tých viac súťaživejších z vás bude v cieli zaznamenávané poradie v akom teamy dorazia a po závode sa vyhlási víťaz, ktorý obdrží titul BANSKEHO PRASAKA. Samozrejme je nutné aby prišli všetci členovia daného tímu do cieľu naraz ! Preto nenechávajte svojich vyčerpaných spolubojovníkov pri cestách, chodníkoch alebo kdekoľvek v tráve a dotlačte ich spolu do cieľa.</p>
    ...
    <br>
    <p>pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo .
    pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo 
    .....pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo pivooo pivo piivo pivooo</p>
