<?php
// source: /var/www/html/Prasak/app/config/config.neon 
// source: /var/www/html/Prasak/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'25_App_Model_HospodaModel',
				'26_App_Model_OcoJdeModel',
				'27_App_Model_RegistrationModel',
			...
			'app\\model\\hospodamodel' => array('25_App_Model_HospodaModel'),
			'app\\model\\ocojdemodel' => array('26_App_Model_OcoJdeModel'),
			'app\\model\\registrationmodel' => array('27_App_Model_RegistrationModel'),
			'nette\\security\\iauthenticator' => array('28_App_Model_UserManager'),
			'app\\model\\usermanager' => array('28_App_Model_UserManager'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/Prasak/app',
			'wwwDir' => '/var/www/html/Prasak/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/Prasak/app/../temp',
		));
	}
	 ...
	 */
	public function createService__25_App_Model_HospodaModel()
	{
	...
	/**
	 * @return App\Model\OcoJdeModel
	 */
	public function createService__26_App_Model_OcoJdeModel()
	{
		$service = new App\Model\OcoJdeModel($this->getService('database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__27_App_Model_RegistrationModel()
	{
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/Prasak/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/Prasak/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/Prasak/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/Prasak/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/Prasak/app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Nette\Security\User($this->getService('nette.userStorage'), $this->getService('28_App_Model_UserManager'));
